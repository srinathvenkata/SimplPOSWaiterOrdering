...
public class MySQLJDBC {
    ...
    public MySQLJDBC(String databaseName,String mysqlUserId,String mysqlPassword,String mysqlPortNumber,String hostName)
    {
//        SharedPreferences sharedpreferences = PreferenceManager.getDefaultSharedPreferences(MyApplication.getAppContext());
    ...
    {
//        Log.v("Testing","Called execute raw query for "+query);
...
//            c.setAutoCommit(false);
    ...
    public Boolean checkConnectivity() {
        ...
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Log.v("Connection","jdbc:mysql://"+ this.connectionhost +":"+ this.portNumber +"/"+this.mysqlDatabaseSelection);
